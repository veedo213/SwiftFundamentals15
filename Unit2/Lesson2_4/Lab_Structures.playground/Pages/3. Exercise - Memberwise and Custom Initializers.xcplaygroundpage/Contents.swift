...
let favoriteBook = Book(title: "The Catcher in the Rye", author: "J.D. Salinger", pages: 277, price: 12.99)
...
// Initialize with just the required property, yearPurchased (defaults are used for others)
let myFirstLaptop = Laptop(yearPurchased: 2020)

// Initialize with all three properties using the memberwise initializer
let mySecondLaptop = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2023)
...
print("Height in inches: (heightOne.heightInInches)")
print("Height in centimeters: (heightOne.heightInCentimeters)")

let heightTwo = Height(centimeters: 180)
print("Height in inches: (heightTwo.heightInInches)")
print("Height in centimeters: (heightTwo.heightInCentimeters)")
...
print("Height in centimeters: (someonesHeight.heightInCentimeters)") // Should print 165.1
...
var myHeight = Height(inches: 70) // Example: 70 inches tall
print("Height in inches: (myHeight.heightInInches)") // Should print 70.0
print("Height in centimeters: (myHeight.heightInCentimeters)") // Should print 177.8
