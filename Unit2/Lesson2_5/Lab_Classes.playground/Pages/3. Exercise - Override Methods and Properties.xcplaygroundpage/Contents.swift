...
// Optionally, you could override wasHit for custom shield behavior, but not required for this exercise.
...
// Move right once, print position
defender.moveRight()
print(defender.position) // Output: 1

// Fire once, print remainingFirePower
defender.fire()
print(defender.remainingFirePower) // Output: 4
...
defender.wasHit()
print(defender.shieldStrength) // Output: 20
print(defender.health)         // Output: 100
