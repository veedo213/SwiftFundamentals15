...
// print(falcon.weapon) // This line doesn't work because 'weapon' is not a property of the Spaceship class.

/*
Explanation:
The Spaceship class does not have a property called 'weapon'. 'weapon' is only defined in the Fighter subclass.
Since falcon is an instance of Spaceship (not Fighter), it does not have access to the 'weapon' property.
*/
