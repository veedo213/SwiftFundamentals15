...
incrementSteps()
incrementSteps()
incrementSteps()// Output will be 1, 2, 3
...
func progressUpdate() {
    ...
    } else if steps < goal {        print("You're almost there!")    } else {        print("You beat your goal!")
    }
}
progressUpdate()
// With steps at 3, this will print: You're off to a good start.
